...
class learning_ops(ABC):
    """ Abstract class to run learning operations
    """
...
class operation_1(learning_ops):
    """ Run operation 1 of the learning module
    """
...
class operation_session:
    ...
    def run_config():
        operation_dict = {}
        operations = learning_ops.__subclasses__()
...
class COMMOps:
    """ User-facing static class to run learning operations
    """
    @staticmethod
    def run(**kwargs):
